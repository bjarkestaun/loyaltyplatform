...
.controller('UserMainTestCtrl', function ($scope, $http, $window, $routeParams, Auth, $location, $cookieStore, User, InfoForUser, geolocation) {
  ...
  $scope.chooseMerchant = function(merchant) {
    ...
    $location.path('/merchantdetailstest');
  };
